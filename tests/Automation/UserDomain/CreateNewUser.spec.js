 ...
 */
    ...
    ///////// User Comparison ///////////////
    var sqlQuery = "select * from users where use_username = '" + jsonData.createUser[index].use_username + "'";
    ...
    var match = await compareJsons(sqlFilePath, null, jsonData.createUser[index]);
    if (match) {
      console.log(
    ...
    match = await compareJsons(sqlFilePath, null, jsonData.createEstProfessional[index]);
    if (match) {
      console.log(
    ...
    match = await compareJsons( sqlFilePath, null, jsonData.setHpClinicLeave[index]);
    if (match) {
      console.log(
