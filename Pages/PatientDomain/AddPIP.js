class AddPIP
{
    constructor(page)
    {
        ...
        this.dropdown_PIPEthnicity=page.locator("xpath=//input[@name='ethnicity']")
        this.dropdown_PIPOccupation=page.locator("xpath=//input[@name='occupation']")
        this.txtbox_PIPMobile=page.getByTestId('Mobile')
        this.txtbox_PIPEmail=page.getByTestId('Email')
        this.dropdown_PIPRelation=page.locator("xpath=//input[@name='relationship']")                                     
        this.dropdownPIPNextOfkin=page.locator("xpath=//input[@name='nextOfKin']")
